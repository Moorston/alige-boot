...
<script>
  ...
  import JSelectDepart from '@/components/aligebiz/JSelectDepart'
  import JSelectUserByDep from '@/components/aligebiz/JSelectUserByDep'
  import JSelectMultiUser from '@/components/aligebiz/JSelectMultiUser'
  ...
  import JEditor from '@/components/alige/JEditor'
  import JEllipsis from '@/components/alige/JEllipsis'
  import JGraphicCode from '@/components/alige/JGraphicCode'
  import JSlider from '@/components/alige/JSlider'
  import JSelectMultiple from '@/components/alige/JSelectMultiple'
  import JTreeDict from "../../components/alige/JTreeDict.vue";
      ...
      return {
        ...
        jcheckbox: {
          ...
          options: [
            ...
            { label: 'agile-Boot', value: 'agileboot' },
